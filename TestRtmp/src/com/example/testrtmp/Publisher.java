...
public class Publisher extends Activity implements OnClickListener {
	...
	private void initLayout() {
		...
		LinearLayout preViewLayout = (LinearLayout) myInflate.inflate(
				R.layout.publisher, null);
		layoutParam = new RelativeLayout.LayoutParams(screenWidth, screenHeight);
		topLayout.addView(preViewLayout, layoutParam);

		/* add control button: start and stop */
		btnRecorderControl = (Button) findViewById(R.id.Button_publisher);
