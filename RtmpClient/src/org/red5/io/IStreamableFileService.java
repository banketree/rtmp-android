...
public interface IStreamableFileService {
	...
	/**
	 * Getter for prefix. Prefix is used in filename composition to fetch real
	 * file name.
	 * 
	 * @return Prefix
	 */
	...
	/**
	 * Sets the file extensions serviced. If there are more than one, they are
	 * separated by commas.
	 * 
	 * @param extension
	 */
	...
	/**
	 * Check whether file can be used by file service, that is, it does exist
	 * and have valid extension
	 * 
	 * @param file
	 *            File object
	...
	/**
	 * Return streamable file reference. For FLV files returned streamable file
	 * already has generated metadata injected.
	 * 
	 * @param file
	 *            File resource
