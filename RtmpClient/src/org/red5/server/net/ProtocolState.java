 ...
 */
public class ProtocolState { // 协议状态
	/**
	...
	/**
	 * Checks whether remaining buffer size is greater or equal than buffer
	 * amount and so if it makes sense to start decoding.
	 * 
	 * @param remaining
	 *            Remaining buffer size
	 * @return <code>true</code> if there is data to decode, <code>false</code>
	 *         otherwise
	 */
	 ...
	 * 
	 * @return <code>true</code> if decoding has finished, <code>false</code>
	 *         otherwise
	 */
	 ...
	 * 
	 * @return <code>true</code> if decoding can be continued,
