...
/**
 * Ping event, actually combination of different events. This is also known as a
 * user control message.
 */
public class Ping extends BaseEvent { //ping 事件
	...
	/**
	 * Client buffer. Sent by client to indicate its buffer time in
	 * milliseconds.
	 */
