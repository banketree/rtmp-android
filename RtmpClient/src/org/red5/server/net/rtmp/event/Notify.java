 ...
 */
public class Notify extends BaseEvent implements IStreamData<Notify>,
		IStreamPacket {//通知的事件流
	...
	/**
	 * Duplicate this Notify message to future injection Serialize to memory and
	 * deserialize, safe way.
	 * 
