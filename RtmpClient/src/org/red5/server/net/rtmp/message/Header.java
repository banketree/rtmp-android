 ...
 * RTMP packet header
 */
public class Header implements Constants, Cloneable, Externalizable { //rtmp 包头信息
	...
	/**
	 * Flash player occasionally sends garbage audio that as far as I can tell
	 * exists only to make folks who don't know about it slowly get out-of-sync
	 * audio and video. We now detect that.
	 */
