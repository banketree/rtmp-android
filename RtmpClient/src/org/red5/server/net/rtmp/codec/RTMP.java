 ...
 */
public class RTMP extends ProtocolState { // rtmp协议

	public String[] states = { "connect", "handshake", "connected", "error",
	...
	/**
	 * Handshake state. Server sends handshake request to client right after
	...
	public void setLastWritePacket(int channelId, Packet packet) {
		...
		/*
		 * Packet prevPacket = writePackets.put(channelId, packet); if
		 * (prevPacket != null && prevPacket.getData() != null) {
		 * prevPacket.getData().release(); prevPacket.setData(null); }
		 */
	}
	...
	public String toString() {
		return "RTMP [state=" + states[state] + ", client-mode=" + mode
				+ ", debug=" + debug + ", encrypted=" + encrypted
				+ ", lastReadChannel=" + lastReadChannel
				+ ", lastWriteChannel=" + lastWriteChannel + ", readHeaders="
				+ readHeaders + ", writeHeaders=" + writeHeaders
				+ ", readPacketHeaders=" + readPacketHeaders + ", readPackets="
				+ readPackets + ", writePackets=" + writePackets
				+ ", writeTimestamps=" + writeTimestamps + ", liveTimestamps="
				+ liveTimestamps + ", readChunkSize=" + readChunkSize
				+ ", writeChunkSize=" + writeChunkSize + ", encoding="
				+ encoding + "]";
	}
