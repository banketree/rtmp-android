...
public class FlexSharedObjectMessage extends SharedObjectMessage { //flex共享数据
	...
	/**
	 * Creates Flex Shared Object event with given name, version and persistence
	 * flag
	 * 
	 * @param name
	 *            Event name
	...
	/**
	 * Creates Flex Shared Object event with given listener, name, SO version
	 ...
	 *            SO persistence flag
	 */
	public FlexSharedObjectMessage(IEventListener source, String name,
			int version, boolean persistent) {
