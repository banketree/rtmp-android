...
public class ServiceUtils {// 服务辅助

	private static final Logger log = LoggerFactory
			.getLogger(ServiceUtils.class);

	// used to prevent extra object creation when a method with a set of params
	// is not found
	...
	public static Object[] findMethodWithExactParameters(Object service,
		...
		try {
			// try to skip the listing of all the methods by checking for
			// exactly what
			// we want first
