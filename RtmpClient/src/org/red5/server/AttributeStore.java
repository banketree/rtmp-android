...
public class AttributeStore implements ICastingAttributeStore {
	...
	/**
	 * Creates empty attribute store. Object is not associated with a
	 * persistence storage.
	 */
	...
	/**
	 * Creates attribute store with initial values. Object is not associated
	 * with a persistence storage.
	 * 
	 * @param values
	 *            map
	 */
