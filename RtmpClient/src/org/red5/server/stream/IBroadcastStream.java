 ...
 */
public interface IBroadcastStream extends IStream {// 广播流
	 ...
	 */
	void saveAs(String filePath, boolean isAppend) throws IOException,
			ResourceNotFoundException, ResourceExistException;

	/**
	 * Get the filename the stream is being saved as.
	 * 
	 * @return The filename relative to the scope or <code>null</code> if the
	 *         stream is not being saved.
	 */
