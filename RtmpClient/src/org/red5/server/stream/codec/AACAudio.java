 ...
 */
public class AACAudio implements IAudioStreamCodec { // aac语音编码

	private static Logger log = LoggerFactory.getLogger(AACAudio.class);

	public static final int[] AAC_SAMPLERATES = { 96000, 88200, 64000, 48000,
	...
	// byte[] b = new byte[] {
	// (byte) (0x10 | /*((profile > 2) ? 2 : profile << 3) | */((sampleRateIndex
	// >> 1) & 0x03)),
