 ...
 * 
 * Store DecoderConfigurationRecord and last keyframe (for now! we're cooking a
 * very exciting new!)
 * 
 * @author Tiago Jacobs (tiago@imdt.com.br)
 * @author Paul Gregoire (mondain@gmail.com)
 */
public class AVCVideo implements IVideoStreamCodec { // 视频编码
