...
public class FileProvider implements IPassive, ISeekableProvider,
		IPullableProvider, IPipeConnectionListener, IStreamTypeAwareProvider { // 文件传输
	/**
	 * Logger
	 */
	...
	private void init() throws IOException {
		// IStreamableFileFactory factory = (IStreamableFileFactory)
		// ScopeUtils.getScopeService(scope, IStreamableFileFactory.class,
