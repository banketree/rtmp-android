...
public interface IStreamCapableConnection extends IConnection {// 支持流式连接
	 ...
	 */
	void unreserveStreamId(int streamId); // 不保留
	 ...
	 */
	void deleteStreamById(int streamId); // 删除某流
	 ...
	 */
	IClientBroadcastStream newBroadcastStream(int streamId); // 客户端广播
	 ...
	 */
	long getPendingVideoMessages(int streamId); // 获取视频消息
